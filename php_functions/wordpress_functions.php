 ...
 * @param $echo boolean Switches between echo-ing and returning the result.
 * @return $deeplink The resulting deeplink
 */
function build_deeplink($base_url = null, $params = [], $echo = false){
